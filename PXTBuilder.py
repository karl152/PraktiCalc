...
class PXTBuilder(ttk.Frame):
    def __init__(self, tabs, parent, mainWin, helper, calculator, dialog, DarkMode):
        ...
        for index, label in enumerate(["Name", "Version", "Description", "Website"]):
            ttk.Label(self, text=label + ":").grid(row=index, column=0, padx=10, sticky=tk.W)
        ...
        self.NameEntry.grid(row=0, column=1, padx=10, pady=10, sticky=tk.EW)
        self.DescriptionEntry.grid(row=2, column=1, padx=10, pady=10, sticky=tk.EW)
        ...
        self.PyVerFrame.grid(row=4, column=0, columnspan=2, padx=10, pady=10, sticky=tk.W)
        ...
        self.InternetConnectionCheckbox.grid(row=5, column=0, columnspan=2, padx=10, pady=10, sticky=tk.W)
        ...
        self.LicenseLabel.grid(row=2, column=2, sticky=tk.W, padx=(25, 0))
