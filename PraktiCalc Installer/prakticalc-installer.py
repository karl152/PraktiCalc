...
def actuallyInstall():
    ...
    if platform.system() == "Windows":
        ...
        if platform.release() == "Vista" or "7" or "8" or "8.1" or "10" or "11":
            ...
            print(subprocess.getoutput(r'reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\PraktiCalc" /v DisplayVersion /t REG_SZ /d "1.3.3" /f'))
