...
def History() :
    ...
    HistoryLabel1 = ttk.Label(HistoryX, text=History1)
    HistoryLabel2 = ttk.Label(HistoryX, text=History2)
    HistoryLabel3 = ttk.Label(HistoryX, text=History3)
    HistoryLabel4 = ttk.Label(HistoryX, text=History4)
    HistoryLabel5 = ttk.Label(HistoryX, text=History5)
    HistoryLabel6 = ttk.Label(HistoryX, text=History6)
    HistoryLabel7 = ttk.Label(HistoryX, text=History7)
    HistoryLabel8 = ttk.Label(HistoryX, text=History8)
    HistoryLabel9 = ttk.Label(HistoryX, text=History9)
    HistoryLabel10 = ttk.Label(HistoryX, text=History10)
    HistoryLabel11 = ttk.Label(HistoryX, text=History11)
    HistoryLabel12 = ttk.Label(HistoryX, text=History12)
    HistoryLabel13 = ttk.Label(HistoryX, text=History13)
    HistoryLabel14 = ttk.Label(HistoryX, text=History14)
    HistoryLabel15 = ttk.Label(HistoryX, text=History15)
    ClearButton = ttk.Button(HistoryX, text="🗑", command=clearHistory)
    HistoryLabel.place(x=0, y=0)
    HistoryLabel1.place(x=0, y=25)
    HistoryLabel2.place(x=0, y=50)
    HistoryLabel3.place(x=0, y=75)
    HistoryLabel4.place(x=0, y=100)
    HistoryLabel5.place(x=0, y=125)
    HistoryLabel6.place(x=0, y=150)
    HistoryLabel7.place(x=0, y=175)
    HistoryLabel8.place(x=0, y=200)
    HistoryLabel9.place(x=0, y=225)
    HistoryLabel10.place(x=0, y=250)
    HistoryLabel11.place(x=0, y=275)
    HistoryLabel12.place(x=0, y=300)
    HistoryLabel13.place(x=0, y=325)
    HistoryLabel14.place(x=0, y=350)
    HistoryLabel15.place(x=0, y=375)
